...
const Cart = () => {
	...
	return (
		...
		</div> : <div className="flex items-center flex-col justify-center py-5">
			<img className="w-7 text-center" src={assets.cart_icon} alt="" />
			<h2 className="text-lg text-center pt-2">Your cart is empty.Please add some product.</h2>
		</div>
		}
